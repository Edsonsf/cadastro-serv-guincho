...
CREATE TABLE IF NOT EXISTS checklist_servico (
  ...
  paralama_estado ENUM('ok', 'avariado', 'nao_verificado') DEFAULT 'nao_verificado',
  paralama_obs TEXT,
  capo_estado ENUM('ok', 'avariado', 'nao_verificado') DEFAULT 'nao_verificado',
  capo_obs TEXT,
  teto_estado ENUM('ok', 'avariado', 'nao_verificado') DEFAULT 'nao_verificado',
  teto_obs TEXT,
  macaco_estado ENUM('ok', 'avariado', 'nao_verificado') DEFAULT 'nao_verificado',
  macaco_obs TEXT,
  triangulo_estado ENUM('ok', 'avariado', 'nao_verificado') DEFAULT 'nao_verificado',
  triangulo_obs TEXT,
  extintor_estado ENUM('ok', 'avariado', 'nao_verificado') DEFAULT 'nao_verificado',
  extintor_obs TEXT,
  acessorios_internos_estado ENUM('ok', 'avariado', 'nao_verificado') DEFAULT 'nao_verificado',
  acessorios_internos_obs TEXT,
